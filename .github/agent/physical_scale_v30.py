...
replace_once(terrain_cpp, '            RegionFrequency * 0.62f,\n', '            MassifFrequency,\n')
replace_once(terrain_cpp, '        Settings.ValleyFrequency * 0.30f,\n', '        MajorValleyFrequency,\n')
replace_once(terrain_cpp, '        Settings.ValleyFrequency * 0.72f,\n', '        TributaryFrequency,\n')
replace_once(terrain_cpp, '        Settings.HillFrequency * 0.34f,\n', '        HillFrequency,\n')
replace_once(terrain_cpp, '        Settings.DetailFrequency * 0.26f,\n', '        BroadReliefFrequency,\n')
replace_once(terrain_cpp, '        Settings.DetailFrequency * 0.82f\n', '        LocalReliefFrequency\n')
...
replace_once(terrain_cpp, '        Settings.ValleyDepth * ValleyStrength *\n', '        ValleyReliefVoxels * ValleyStrength *\n')
replace_once(terrain_cpp, '        Settings.ValleyDepth * TributaryValley *\n', '        ValleyReliefVoxels * TributaryValley *\n')
replace_once(terrain_cpp, '        Settings.ValleyDepth * 0.16f * LowlandProvince;\n', '        ValleyReliefVoxels * 0.16f * LowlandProvince;\n')
replace_once(terrain_cpp, '        Settings.ValleyDepth * 0.10f * Result.Cirque;\n', '        ValleyReliefVoxels * 0.10f * Result.Cirque;\n')
replace_once(terrain_cpp,
