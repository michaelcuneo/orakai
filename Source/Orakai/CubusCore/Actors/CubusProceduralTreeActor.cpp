...
void ACubusProceduralTreeActor::RebuildTree()
{
	...
	{
		UE_LOG(LogTemp, Error, TEXT("Cubus failed to generate tree species %s with seed %d."), *Species->GetName(), Seed);
		return;
	}

	TArray<FProcMeshTangent> EmptyTangents;

	TreeMesh->CreateMeshSection_LinearColor(0, Generated.Bark.Vertices, Generated.Bark.Triangles, Generated.Bark.Normals,
											Generated.Bark.UV0, Generated.Bark.VertexColors, EmptyTangents, bGenerateCollision);

	if (Generated.Canopy.IsValid())
	{
		TreeMesh->CreateMeshSection_LinearColor(1, Generated.Canopy.Vertices, Generated.Canopy.Triangles, Generated.Canopy.Normals,
												Generated.Canopy.UV0, Generated.Canopy.VertexColors, EmptyTangents, false);
	}
