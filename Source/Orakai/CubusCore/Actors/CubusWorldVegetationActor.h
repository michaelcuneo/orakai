...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Far Streaming", meta = (ClampMin = "1000"))
	int32 MaximumFarRenderedTrees = 200000;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Ground Detail", meta = (ClampMin = "1", ClampMax = "16"))
	int32 GrassInstancesPerPlacement = 6;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Ground Detail", meta = (ClampMin = "0.0", Units = "cm"))
