 ...
 */
UCLASS(BlueprintType, Blueprintable, ClassGroup = "Cubus", meta = (DisplayName = "Cubus World Vegetation"))
...
public:
	...
	bool FindInteractiveTreeAlongRay(const FVector& TraceStart, const FVector& TraceEnd, float SelectionRadius, FIntVector& OutWorldVoxel);
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Wind",
			  meta = (EditCondition = "bEnableHeroSkeletalWindMode", ClampMin = "0"))
	int32 MaxHeroSkeletalWindComponents = 32;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Wind",
			  meta = (EditCondition = "bEnableHeroSkeletalWindMode", ClampMin = "0", Units = "cm"))
	float HeroSkeletalWindMaxDistance = 10000.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Wind",
			  meta = (EditCondition = "bEnableHeroSkeletalWindMode", ClampMin = "100.0", Units = "cm"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Wind",
			  meta = (EditCondition = "bEnableHeroSkeletalWindMode && bUseInstancedSkeletalFallbackBeyondHeroDistance", ClampMin = "0"))
	...
	int32 PlantStartCullDistance = 0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Rendering", meta = (ClampMin = "0", Units = "cm"))
	int32 PlantEndCullDistance = 0;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Runtime Randomization",
			  meta = (EditCondition = "bEnableRuntimeRandomization"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Runtime Randomization",
			  meta = (EditCondition = "bEnableRuntimeRandomization", ClampMin = "0.0", ClampMax = "180.0", UIMin = "0.0", UIMax = "90.0",
					  Units = "deg"))
	...
	bool bCullByCameraChunkRadius = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Streaming",
			  meta = (ClampMin = "0", UIMax = "24", EditCondition = "bCullByCameraChunkRadius"))
	int32 CameraChunkHorizontalRadius = 8;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Streaming",
			  meta = (ClampMin = "0", UIMax = "12", EditCondition = "bCullByCameraChunkRadius"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Far Streaming", meta = (ClampMin = "10000.0", Units = "cm"))
	float FarVegetationEndCullDistance = 800000.0f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Far Streaming", meta = (ClampMin = "2", ClampMax = "64"))
	int32 FarTreeSampleStrideVoxels = 3;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Far Streaming", meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float FarTreeDensityScale = 0.75f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Far Streaming", meta = (ClampMin = "1", ClampMax = "16"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Placement",
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Grass", meta = (ClampMin = "1", ClampMax = "16"))
	int32 GrassInstancesPerPlacement = 6;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|Grass", meta = (ClampMin = "0.0", Units = "cm"))
