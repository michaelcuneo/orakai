...
UENUM(BlueprintType)
enum class ECubusTerrainMaterialRole : uint8
{
	None,
	Surface,
	Subsurface,
...
UENUM(BlueprintType)
enum class ECubusTerrainMaterialSignal : uint8
{
	SurfaceWorldZ,
	ElevationNormalized,
	Slope,
...
struct ORAKAI_API FCubusTerrainMaterialSignalRule
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	ECubusTerrainMaterialSignal Signal = ECubusTerrainMaterialSignal::Temperature;
...
USTRUCT(BlueprintType)
struct ORAKAI_API FCubusTerrainMaterialSelection
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	ECubusTerrainMaterialRole Role = ECubusTerrainMaterialRole::None;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	float BaseScore = 0.0f;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	float MinimumWinningScore = 0.0f;

	/** Empty accepts every ecological community. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	TArray<FName> CommunityNames;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation", meta = (ClampMin = "0.0"))
	float CommunityScoreWeight = 1.0f;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	TArray<FCubusTerrainMaterialSignalRule> Signals;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation", meta = (ClampMin = "0.0"))
	float VariationFrequency = 0.0f;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation", meta = (ClampMin = "0.0"))
	float VariationScoreAmplitude = 0.0f;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation")
	int32 VariationSalt = 0;
...
struct ORAKAI_API FCubusDensitySurfaceTextures
{
	...
	{
		return IsValid(BaseColor.Get()) || IsValid(Normal.Get()) || IsValid(ORM.Get()) || IsValid(Height.Get()) ||
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Generation", meta = (ShowOnlyInnerProperties))
	FCubusTerrainMaterialSelection TerrainSelection;
	...
	FORCEINLINE bool UsesDensityTextures() const { return DensitySurface.HasAnyTexture(); }
