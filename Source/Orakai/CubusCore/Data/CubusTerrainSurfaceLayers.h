...
ORAKAI_API FCubusTerrainSurfaceLayerMasks EvaluateCubusTerrainSurfaceLayers(const FCubusTerrainSurfaceLayerSettings& Settings,
																			const FVector& WorldPosition, const FVector& WorldNormal,
																			int32 WorldSeed);
