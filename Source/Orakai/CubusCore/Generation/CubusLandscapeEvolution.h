...
{
public:
	static bool				   GenerateSkeleton(const FSettings& Settings, FGlobalDem& OutDem, FGenerationStats* OutStats = nullptr,
												FString* OutError = nullptr);
	static bool				   SolveHydrology(const FSettings& Settings, FGlobalDem& InOutDem, FGenerationStats* OutStats = nullptr,
											  FString* OutError = nullptr);
	static bool				   EvolveLandscape(const FSettings& Settings, FGlobalDem& InOutDem, FGenerationStats* OutStats = nullptr,
											   FString* OutError = nullptr);
	static void				   MeasureQuality(const FGlobalDem& Dem, FGenerationStats& OutStats);
