...
struct FCubusCompiledTerrainMaterialRule
{
	int32						   MaterialId = 0;
	FCubusTerrainMaterialSelection Selection;
};
...
struct ORAKAI_API FCubusTerrainDensitySettings
{
	...
	TArray<FCubusCompiledTerrainMaterialRule> MaterialSelectionRules;
...
private:
	...
	int32 SelectMaterialRule(ECubusTerrainMaterialRole Role, float WorldX, float WorldY, const FSurfaceMaterialData& MaterialData,
							 const FColumnData& Column, int32 FallbackMaterialId) const;
