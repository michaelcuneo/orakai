...
public:
	...
	static void BuildChunk(const FCubusDensitySamplingBuffer& DensityBuffer, float VoxelSize, float IsoLevel,
						   TMap<int32, FCubusMeshData>& OutMaterialMeshes, int32& OutGeneratedTriangleCount,
						   const ICubusDensityField* SurfaceMaterialField = nullptr, const ICubusDensityField* TransitionField = nullptr,
	 ...
	 */
	static void BuildAdaptiveChunk(const ICubusDensityField& DensityField, const FIntVector& ChunkCoordinate, float CanonicalVoxelSize,
								   int32 SubdivisionsPerVoxel, float IsoLevel, TMap<int32, FCubusMeshData>& OutMaterialMeshes,
