...
UCLASS(BlueprintType, Blueprintable, ClassGroup = "Cubus", meta = (BlueprintSpawnableComponent, DisplayName = "Cubus Megaplant Renderer"))
...
public:
	...
	bool IsVegetationActive() const { return bVegetationActive; }
	...
	bool IsConfigurationOnly() const { return bConfigurationOnly; }
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|PVE|Growth",
			  meta = (ClampMin = "1.0", Units = "s", EditCondition = "bRenderInstancedTrees && bSimulateTreeGrowth"))
	...
	int32 TreeStartCullDistance = 0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Cubus|Vegetation|PVE",
			  meta = (ClampMin = "0", Units = "cm", EditCondition = "bRenderInstancedTrees"))
	int32 TreeEndCullDistance = 0;
